...
![:scale 50%](02_pics/birdmon_team.png)
...
Among the formal research projects our team has been involved in, SoIB is the biggest and its scope actually extends much further beyond NCF---SoIB is a partnership of 13 governmental and non-governmental organisations, among which NCF is but one.
...
Long-term Change (pre-2000--present), Current Annual Trend (2015--2022), Distribution Range Size
...
Aside from looking at how individual species are doing, we can investigate groups to understand broader patterns. For example, Indian Roller is a very familiar bird, but not doing very well. It is an open habitat specialist.
...
Unfortunately, the situation is also grim for many of our migratory ducks which are in decline.
