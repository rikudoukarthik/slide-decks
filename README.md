...
This is a repository hosting all my slide decks for talks/presentations/workshops etc. The repository with its various folders is deployed to a Netlify site, making it possible to access the HTML slides at the URL `https://kartrix-doujutsu.netlify.app/folder-name`(i.e., talk name). Many of these talks are also featured in the [*Slides* section of my website](https://kartrick.com/slides), where talk details and links to the slides as well as the code used to make them are provided. 
